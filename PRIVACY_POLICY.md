# Menie Privacy Policy

*Last updated: [Current Date]*

## Our Privacy-First Commitment

Menie is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
Usage analytics is optional and off by default. When you choose to enable it, Menie collects minimal, anonymized usage data:
...
- **GitHub Issues**: [Create an issue](https://github.com/0xSuleman/Menie/issues)
...
*This privacy policy applies to Menie v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*
