...
When **reviewing recordings** in Menie, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Menie records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Menie recordings** - Use wired/speakers instead
...
### This is Not a Menie Bug

The issue is in **macOS's Bluetooth audio stack**, not in Menie's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Menie bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Menie now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Menie v0.0.5+ on macOS
