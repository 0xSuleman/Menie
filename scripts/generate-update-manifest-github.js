...
console.log(`GitHub Repository: 0xSuleman/Menie`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/0xSuleman/Menie/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/0xSuleman/Menie/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/0xSuleman/Menie/releases/latest/download/latest.json`);
