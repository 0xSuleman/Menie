...
Thank you for your interest in contributing to Menie! This document provides guidelines and instructions for contributing to this project.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Menie.git
   ```
3. Add the original repository as upstream:
   ```bash
   git remote add upstream https://github.com/0xSuleman/Menie.git
   ```
