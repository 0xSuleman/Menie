# GPU-accelerated development script for Menie (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Menie" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Menie in development mode..." -ForegroundColor Blue
Write-Host ""
