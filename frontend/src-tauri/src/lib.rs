...
pub fn run() {
    ...
    builder
        ...
        .setup(|_app| {
            ...
            jobs::spawn_processing_worker(_app.handle().clone());
            let scheduled_backup_app = _app.handle().clone();
            tauri::async_runtime::spawn(async move {
                let state = scheduled_backup_app.state::<state::AppState>();
                if let Err(error) =
                    database::commands::run_scheduled_local_backup(&scheduled_backup_app, &state)
                        .await
                {
                    log::warn!("Scheduled local backup check failed: {}", error);
                }
            });
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            whisper_engine::commands::whisper_set_vocabulary,
            ...
            audio::recording_commands::privacy_pause_recording,
            audio::recording_commands::resume_recording,
            audio::recording_commands::is_recording_paused,
            audio::recording_commands::get_recording_state,
            audio::recording_commands::get_capture_health,
            audio::recording_commands::add_recording_marker,
            api::api_save_recording_markers,
            api::api_get_recording_markers,
            api::api_get_meeting_knowledge_excluded,
            api::api_set_meeting_knowledge_excluded,
            api::api_get_project_knowledge_excluded,
            api::api_set_project_knowledge_excluded,
            ...
            api::api_get_meeting_speaker_labels,
            api::api_rename_meeting_speaker_label,
            api::api_relabel_meeting_source_track,
            api::api_reassign_meeting_transcript_speaker,
            api::api_preview_meeting_transcript_replace,
            api::api_apply_meeting_transcript_replace,
            api::api_revise_meeting_transcript_segment,
            api::api_get_meeting_transcript_segment_revisions,
            api::api_query_meeting_evidence,
            api::api_query_library_evidence,
            api::api_create_audio_clip,
            api::api_get_meeting_clips,
            api::api_delete_meeting_clip,
            api::api_get_meeting_comments,
            api::api_add_meeting_comment,
            api::api_resolve_meeting_comment,
            api::api_get_meeting_audio_path,
            api::api_get_meeting_attachments,
            api::api_add_meeting_attachment,
            api::api_delete_meeting_attachment,
            api::api_encrypt_local_handoff,
            api::api_decrypt_local_handoff,
            api::api_validate_local_plugin_manifest,
            api::api_import_meeting_bundle,
            api::api_rebuild_knowledge_index,
            api::api_get_knowledge_index_status,
            api::api_get_meeting_talk_time,
            api::api_get_project_talk_time_trend,
            api::api_save_meeting_title,
            api::api_get_meeting_calendar_context,
            api::api_save_meeting_calendar_context,
            api::api_save_meeting_project,
            api::api_get_meeting_retention,
            api::api_save_meeting_retention,
            api::api_get_meeting_tags,
            api::api_save_meeting_tags,
            api::api_get_project_vocabulary,
            api::api_save_project_vocabulary,
            api::api_prepare_webhook_delivery,
            api::api_get_outbound_webhook_policy,
            api::api_set_outbound_webhook_policy,
            api::api_get_meeting_deliveries,
            api::api_approve_webhook_delivery,
            api::api_dispatch_webhook_delivery,
            api::api_get_local_audit_events,
            api::api_get_local_privacy_report,
            api::api_get_local_health_report,
            api::api_create_local_sample_meeting,
            api::api_set_meeting_pinned,
            api::api_set_meeting_archived,
            api::api_set_meeting_trashed,
            api::api_merge_meetings,
            api::api_split_meeting,
            api::api_bulk_set_meeting_trashed,
            ...
            audio::recording_preferences::get_recording_storage_status,
            ...
            database::commands::create_verified_local_backup,
            database::commands::verify_local_backups,
            database::commands::get_local_storage_usage,
            database::commands::relocate_meeting_library,
            database::commands::preview_local_storage_cleanup,
            database::commands::cleanup_local_storage,
            database::commands::secure_cleanup_local_storage,
            database::commands::get_local_backup_schedule,
            database::commands::set_local_backup_schedule,
            whisper_engine::commands::open_models_folder,
            // Onboarding commands
            onboarding::get_onboarding_status,
            onboarding::get_local_model_profiles,
            meeting_detection::get_detected_meeting_apps,
            jobs::enqueue_deferred_transcription,
            jobs::list_processing_jobs,
            jobs::cancel_processing_job,
