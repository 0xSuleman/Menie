      ...
      {transcripts.length === 0 && (
        ...
        >
          {isRecording ? (
            ...
            <div className="brand-card mx-auto mt-10 max-w-md rounded-3xl p-8 text-center shadow-lg shadow-blue-100/60">
              <img
                src="/menie-logo.png"
                alt="MENIE logo"
                className="mx-auto mb-5 h-24 w-24 rounded-2xl shadow-sm"
              />
              <p className="font-brand text-xl text-blue-800">MENIE</p>
              ...
              <div className="mt-5 flex flex-wrap justify-center gap-2 text-[11px] font-semibold text-blue-700">
