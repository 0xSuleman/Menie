...
export function OnboardingContainer({
  ...
  return (
    <div className="brand-shell fixed inset-0 flex items-center justify-center z-50 overflow-hidden">
      <div
        className={cn(
      ...
      >
        ...
        <div className="mb-4 text-center space-y-3 flex-shrink-0">
          <div className="mb-2 flex items-center justify-center gap-3">
            ...
            />
            <span className="font-brand text-sm text-blue-700">MENIE</span>
          </div>
          <h1 className="font-brand text-3xl text-slate-900 animate-fade-in-up">
            {title}
          </h1>
          {description && (
