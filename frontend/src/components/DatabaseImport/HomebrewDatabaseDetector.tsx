...
const HOMEBREW_PATHS = [
  "/opt/homebrew/var/menie/meeting_minutes.db", // Apple Silicon (M1/M2/M3)
  "/usr/local/var/menie/meeting_minutes.db", // Intel Macs
];
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Previous Menie Installation Detected!
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            We found an existing database from your previous Menie installation
          ...
          <p className="text-sm text-blue-800 mb-3">
            Would you like to import your previous meetings, transcripts, and
            summaries?
          </p>
