...
export function UpdateDialog({
  ...
  const handleDownloadAndInstall = async () => {
    ...
    try {
      // Guard this direct progress-aware updater path too; the service is the
      // single source of truth for whether capture may be interrupted.
      await updateService.assertInstallationAllowed();
      let downloaded = 0;
      let contentLength = 0;
