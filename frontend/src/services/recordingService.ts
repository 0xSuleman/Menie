...
export class RecordingService {
  ...
  /** Stop saving and transcribing newly captured audio until resumed. */
  async privacyPauseRecording(): Promise<void> {
    return invoke("privacy_pause_recording");
  }
  ...
  async onRecordingPrivacyPaused(callback: () => void): Promise<UnlistenFn> {
    return listen("recording-privacy-paused", callback);
  }
