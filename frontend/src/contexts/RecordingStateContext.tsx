...
interface RecordingState {
  ...
  isPrivacyPaused: boolean; // Is capture paused explicitly for privacy
  ...
  const syncWithBackend = async () => {
    try {
      ...
      setState((prev) => ({
        ...
        isPrivacyPaused: backendState.is_privacy_paused,
  ...
  useEffect(() => {
    ...
    const setupListeners = async () => {
      try {
        ...
        const unlistenPrivacyPaused =
          await recordingService.onRecordingPrivacyPaused(() => {
            setState((prev) => ({
              ...prev,
              isPaused: true,
        ...
        unsubscribers.push(unlistenPrivacyPaused);
