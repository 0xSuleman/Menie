...
import { Transcript, SummaryDocument } from "@/types";
  ...
  const handleCopySummary = useCallback(async () => {
    try {
      ...
      if (!summaryMarkdown && aiSummary) {
        ...
        console.log(
          "📝 Converted legacy format, length:",
          summaryMarkdown.length,
        );
      }
